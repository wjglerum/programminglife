...
public class Patients extends Controller {
    ...
    public static Result showAll() throws SQLException, IOException {
        return ok(patients.render(
                patientService.getAll(Authentication.getUser().getId()),
    ...
    public static Result patientNotFound() throws SQLException, IOException {
        flash("patient-not-found", "The requested patient could not be found. "
    ...
    public static class Add {
        ...
        private String checkName() {
            ...
            } else if (surname == null || surname.length() < minimumLength) {
        ...
        private boolean checkFileExtension(final String fileName) {
            ...
            return fileName.substring(fileName.length() - minimumLength)
                    .equals(".vcf");
        }
    ...
    public static Result insert() throws SQLException {
        ...
        if (addForm.hasErrors()) {
            ...
            // Make user happy
            flash("patient-added",
                    "The patient " + p.getName() + " " + p.getSurname()
    ...
    private static Patient makePatient(Form<Add> addForm, Long fileSize,
        ...
        Patient p = patientService.add(Authentication.getUser().getId(), name,
    ...
    private static class Errors {
        ...
        private enum errorType {
            INVALID_NAME("An invalid name is entered. " + "Please fill in "
                    + "a name consisting of at " + "least 3 characters"), INVALID_SURNAME(
                    "An invalid surname is entered. " + "Please fill in a "
                            + "surname consisting of at "
                            + "least 3 characters"), INVALID_EXTENSION(
                    "The uploaded " + "file doesn't" + " have the " + ".vcf "
                            + "extension"), WRONG_CONTENT_TYPE(
                    "File has wrong " + "content " + "type"), NO_VCF(
     ...
     * @param p
     *            The patient that the vcf file belongs to.
     */
    public static final void setupReaderThread(final String filePath,
            final Patient p) {
