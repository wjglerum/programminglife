...
public class MutationRepositoryDB implements MutationRepository {
    ...
    public void prepareQueries(final String database) throws IOException {
        try (Connection connection = DB.getConnection(database);) {
            getAll = generatePreparedStatement("getAll", connection);
            get = generatePreparedStatement("get", connection);
            getPosition = generatePreparedStatement("getPosition", connection);
     ...
     */
    public PreparedStatement generatePreparedStatement(String queryName,
            Connection connection) throws SQLException, IOException {
        String path = "private/sql/mutations/" + queryName + ".sql";
