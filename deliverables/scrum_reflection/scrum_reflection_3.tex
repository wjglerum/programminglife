...
Make log-in page & 3 & Jasper & 8 hours & Yes & Used Plays built in Security/Authentication framework. Took some time to figer out but worked in the end. Login page built using Bootstrap. Secured pages are redirected to log-in page when users isn't logged in\\
