...
\begin{itemize}
  \item Read the VCF file and find mutations of two types: de novo's and recessive homozygous. We have chosen these two types of mutations since they are the most suspicious, most likely to cause a desease, and therefore the most interesting
